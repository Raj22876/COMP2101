...
| --help / -h : Will show Help Information regarding this function |
|                                                                  |
| --host :  Will show Host name                                    |
|                                                                  |
| --domain : Will show Domain name                                 |
|                                                                  |
| --ipconfig : Will show IP configuration and status               |
|                                                                  |
| --os : Will show Operating System inforamation                   |
|                                                                  |
| --cpu : Will show CPU information                                |
|                                                                  |
| --memory : Will show Memory information                          |
|                                                                  |
| --disk : Will show Disk / Storage information                    |
|                                                                  |
| --printer : Will show Printer related information                |
‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾‾"
}
